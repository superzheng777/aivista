    ...
    return (
        <Card
            className={cn(
                ...
                isSelected &&
                    'ring-2 ring-primary border-primary/20 bg-primary/5 shadow-primary/10'
            )}
                        ...
                        <div className="flex flex-wrap gap-1.5">
                            {style.tags.slice(0, 3).map((tag) => (
                                <Badge
                                    key={tag}
                                    variant="outline"
                                    className="text-[10px] h-5 px-2 bg-background/40 hover:bg-background transition-colors border-muted-foreground/10 text-muted-foreground/90"
                                >
                                    {tag}
                                </Badge>
                            ))}
