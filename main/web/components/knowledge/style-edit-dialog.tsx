                        ...
                        <div className="space-y-1">
                            <div className="flex items-center gap-2">
                                ...
                                {isSystem && (
                                    <Badge
                                        variant="outline"
                                        className="bg-primary/5 text-primary border-primary/20 text-[10px] uppercase font-bold px-2"
                                    >
                                        System
                                    </Badge>
                                )}
                                    ...
                                    <div className="flex flex-wrap gap-2">
                                        {style.tags.map((tag) => (
                                            <Badge
                                                key={tag}
                                                variant="secondary"
                                                className="px-3 py-1 bg-muted/50 hover:bg-muted text-xs transition-colors"
                                            >
                                                {tag}
                                            </Badge>
                                        ))}
